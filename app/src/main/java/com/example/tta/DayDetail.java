...
import static com.example.tta.WeekActivity.SEL_DAY;
import static com.example.tta.WeekActivity.sharedPreferences;
...
public class DayDetail extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        if(getSupportActionBar() != null) {
            getSupportActionBar().setTitle(sharedPreferences.getString(SEL_DAY,null));
        }
